...
public class finalBill {
    // static String[]india={"Veg Thali","Non-Veg Thali","Veg Pulav","Masala
    // chai","Chicken Biryani","Chapathi","Gulab Jamun"};
    static int[] indiacost = { 79, 119, 99, 20, 220, 49, 99 };
    // String[] french={"French onion soup","Chicken confit","Cassoulet","Chocolate
    // souffle","Shallots","Truffle"};
    int[] frenchcost = { 230, 250, 400, 499, 370, 249 };
    // String[] China={"Chicken hot and sour Soup","Chicken Manchurian","Chicken
    // noodles","Chilli Chicken","Schezwan FriedRice","Spring Rolls"};
    int[] chinacost = { 200, 160, 120, 140, 150, 75 };
    // static String[] Italy={"pizza","spaghetti","carpaccio","caprese","vegetable
    // sauce","ciabatta"};
    ...
    public void finalb(int[] in, int[] it, int[] chi, int[] fra) {
        ...
        dialog.setContentPane(new JLabel(new ImageIcon("Backgrounds/bill.jpg")));
        ...
        for (int i = 0; i < in.length; i++) {
            ...
            if (in[i] != 0) {
                ...
                costdefault.addElement(Integer.toString(in[i]) + "X" + Integer.toString(indiacost[i]) + "="
                        + Integer.toString(indiacost[i] * in[i]) + "/-");
        ...
        for (int i = 0; i < chi.length; i++) {
            if (chi[i] != 0) {
                ...
                costdefault.addElement(Integer.toString(chi[i]) + "X" + Integer.toString(chinacost[i]) + "="
                        + Integer.toString(chinacost[i] * chi[i]) + "/-");
        ...
        for (int i = 0; i < fra.length; i++) {
            if (fra[i] != 0) {
                ...
                costdefault.addElement(Integer.toString(fra[i]) + "X" + Integer.toString(frenchcost[i]) + "="
                        + Integer.toString(frenchcost[i] * fra[i]) + "/-");
        ...
        for (int i = 0; i < it.length; i++) {
            ...
            if (it[i] != 0) {
                ...
                costdefault.addElement(Integer.toString(it[i]) + "X" + Integer.toString(italycost[i]) + "="
                        + Integer.toString(italycost[i] * it[i]) + "/-");
...
// String[]india={"Veg Thali","Non-Veg Thali","Veg Pulav","Masala chai","Chicken
// Biryani","Chapathi","Gulab Jamun"};
...
// String[] Italy={"pizza","spaghetti","carpaccio","caprese","penne with
// vegetable sauce","ciabatta"};
...
// public void finalBill(int[] indian,int[] frenchian,int[] chinese,int []
// italian){
// //////////////////////headings////////////////////////////
...
// "+frenchian[i]+"==>"+frenchian[i]*frenchcost[i]);
...
// bill.setLayout(GridBagLayoutgrid);//new
// GridLayout(indian.length+frenchian.length+chinese.length+italian.length,2));
...
// // import java.util.*;
// // public class FinalBill {
// // String[]india={"Veg Thali","Non-Veg Thali","Veg Pulav","Veg
// Friedrice","Chicken Biryani","Chicken Friedrice"};
// // int[]indiacost={80,120,100,125,220,180};
// // String[] french={"french Onion Soup","Chicken
// Confit","Cassoulet","Chocolate Souffle","Shallots","Truffle"};
// // int[]frenchcost={230,250,400,500,400,270};
// // String[] China={"Chicken Manchurian","Chicken Noodles","Chilli
// Chicken","Schezwan Fried Rice","Spring Rolls"};
// // int[]chinacost={200,160,180,140,150};
// // String[] Italy={"Napoletana Pizza","Risotto","Fiorentian
// Steak","Polente","Lasagne"};
// // int[]italycost={500,100,1500,700,1500};
// // JLabel disindia[],costindia[],disfrench[],costfrench[],
// dischina[],costchina[],disitaly[], costitaly[];
// // int actual[];
// // int count;
// // int j=0;
// // float stotal,gst,fina;
