...
public class french implements ActionListener {
    public static String[] listfrance = { "French onion soup", "Chicken confit", "Cassoulet", "Chocolate souffle",
            "Shallots", "Truffle" };
    ...
    static Icon sub = new ImageIcon("Backgrounds/Indian\\submit.jpg");
    static JButton submit = new JButton("ADD TO PLATE");// new ImageIcon("Backgrounds/Indian\\submit.jpg"));
