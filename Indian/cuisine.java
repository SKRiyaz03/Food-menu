...
public class cuisine implements ActionListener {
    public static String[] listchina = { "Chicken hot and sour Soup", "Chicken Manchurian", "Chicken noodles",
            "Chilli Chicken", "Schezwan FriedRice", "Spring Rolls" };
    ...
    public void China() {
        ...
        chinese = new JDialog();
        chinese.setContentPane(new JLabel(new ImageIcon("Backgrounds/chinese.jpg")));
