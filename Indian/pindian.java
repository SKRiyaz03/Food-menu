...
public class pindian implements ActionListener {
    public static String[] listindia = { "Veg Thali", "Non-Veg Thali", "Veg Pulav", "Masala chai", "Chicken Biryani",
            "Chapathi", "Gulab Jamun" };
    ...
    public void India() {
        ...
        bharat.setContentPane(new JLabel(new ImageIcon("Backgrounds/pindain.jpg")));
